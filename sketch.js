...
function preload()
{
	boyImg = loadImage("images for mango/boy.png");
}
...
function setup() {
	...
	mango6 = new Mango(700,330,15)
	mango7 = new Mango(740,370,15);
	mango8 = new Mango(680,200,15);
	mango9 = new Mango(900,210,15)
	mango10 = new Mango(710,200,15);
